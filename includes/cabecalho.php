<?php
$base = $base ?? "./";
require_once __DIR__ . "/conexao.php"; /* Conexão com o banco de dados, pagina só funciona se conectar */
...
<?php if ($logado) : ?>
    <div class="login">
        <button id="bntLogin" onclick="abrirModal()">
            <img src="<?php echo $base; ?>img-icones/brigadeiro-icone-menu.png" alt="Menu">
        </button>
    </div>
...
<?php else : ?>
    <div class="login">
        <button id="bntLogin" onclick="abrirModal()">
            <img src="<?php echo $base; ?>img-icones/brigadeiro-icone-menu2.png" alt="Menu">
    ...
    <header> <!-- É usado para representar o cabeçalho de uma página ou de uma seção. -->
        ...
        <nav> <!-- <nav> </nav> É usado para agrupar os links de navegação  -->
            ...
            <ul> <!-- <ul> </ul> É usado para criar uma lista não ordenada de links de navegação e <li> </li> é obrigatório para lista -->
                <li><strong><a href="<?php echo $base; ?>index.php">Início</a></strong></li>
                <li><strong><a href="<?php echo $base; ?>pages/encomendas/encomenda.php">Encomendar</a></strong></li>
                <li><strong><a href="<?php echo $base; ?>pages/institucional/contato.php">Contato</a></strong></li>
            </ul>
